    ...
    fun generateRemoteDummyMovies(): List<MovieEntity> {
        ...
        movies.add(
            MovieEntity(
                ...
                "Star Wars: The Rise of Skywalker",
                "en",
                "o86DbpburjxrqAzEDhXZcyE8pDb.png",
        ...
        movies.add(
            MovieEntity(
                ...
                "Cars",
                "en",
                "uq3N2SFj1Y06zA6LzCQPkmBdaaE.jpg",
        ...
        movies.add(
            MovieEntity(
                ...
                "Little Women",
                "en",
                "mSmiB8XjUnR1GSIljuCPGsk0cwX.jpg",
        ...
        movies.add(
            MovieEntity(
                ...
                "Men in Black",
                "en",
                "t66nzsDMHLzzUe4rImT9qsgFk0B.jpg",
        ...
        movies.add(
            MovieEntity(
                ...
                "ja",
                "gKxbKcJCPp6IH5auhP1tFbMXsJE.jpg",
    ...
    fun generateRemoteDummyTvShows(): List<TvShowEntity> {
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "Mindhunter",
                "en",
                "fbKE87mojpIETWepSbD5Qt741fp.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "Miami Vice",
                "en",
                "6psPEKu03UCiLqBxzeSy7wRQOVN.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "ポケモン",
                "ja",
                "2pcTUs20ysCdA6DZclaPmGXD6ph.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "戦国お伽草子–犬夜叉",
                "ja",
                "zEHGWEMtqdXXhao8PeRqTmpaE6P.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "ヴァイオレット・エヴァーガーデン",
                "ja",
                "ImvHbM4GsJJykarnOzhtpG6ax6.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "とある科学の超電磁砲",
                "ja",
                "av91c29m40cQ2YXLIp4V76cktjU.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "とある魔術の禁書目録",
                "ja",
                "zNJC5IfgCCP6hXDHgwrULqXWicm.jpg",
        ...
        tvShows.add(
            TvShowEntity(
                ...
                "ja",
                "eKr4p1jBL081BwqWJ1zywtJIqMF.jpg",
